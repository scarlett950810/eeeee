 ...
 * @author Howard
 */
@FacesConverter(value = "airportConverter1")
public class AirportConverter1 implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if (value != null && value.trim().length() > 0) {
            try {
                ...
                List<AirportEntity> airportEntities = (List<AirportEntity>)fc.getExternalContext().getSessionMap().get("airportHubList");
