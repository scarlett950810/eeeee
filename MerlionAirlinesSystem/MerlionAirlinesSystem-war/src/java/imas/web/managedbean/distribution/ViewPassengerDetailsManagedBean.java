...
@ManagedBean
@SessionScoped
public class ViewPassengerDetailsManagedBean implements Serializable {
    ...
    public ViewPassengerDetailsManagedBean() {
    }
    ...
    public List<BookingClassEntity> getBookingClassList() {
        ...
        System.out.println("get bookingclasslis");
    ...
    public List<TicketEntity> getTicketsList() {
        ...
        ticketsList = (List<TicketEntity>)FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("ticketList");
        System.out.println("get Ticket likst");
        return ticketsList;
    }
    ...
    public void viewBookingClass() throws IOException {
        ...
        ticketsList = selectedFlight.getTickets();
        FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("ticketList", ticketsList);
        

   
        FacesContext fc = FacesContext.getCurrentInstance();
        ExternalContext ec = fc.getExternalContext();
        ec.redirect("distributionPassengerDetailsManagement.xhtml");
    }
    ...
    public void returnBack() throws IOException {
        FacesContext fc = FacesContext.getCurrentInstance();
        ExternalContext ec = fc.getExternalContext();
        ec.redirect("viewPassengerDetails.xhtml");
    }
