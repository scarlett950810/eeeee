 ...
 * @author ruicai
 */
@FacesConverter("bookingClassConverter2")
public class BookingClassConverter2 implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if (value != null && value.trim().length() > 0) {
            try {
                ...
                List<BookingClassEntity> bookingClassEntities = (List<BookingClassEntity>)fc.getExternalContext().getSessionMap().get("availableBookingClassList");
